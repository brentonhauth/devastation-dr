...
(function (scenes) {
    var Prologue = /** @class */ (function (_super) {
        ...
        function Prologue() {
            ...
            _this.counterPoint = new math.Vec2(56, 65).Scale(_this.storeScale).Add(_this.storePos);
            _this.doorPoint = new math.Vec2(74, 119).Scale(_this.storeScale).Add(_this.storePos);
